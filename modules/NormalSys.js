...
////////////////////////測試用
	...
	else if (trigger.match(/^戰鬥系統測試$/) != null) return exports.Testing.SimBattle(UserID,GroupID,UserN);//測試開啟戰鬥系統功能用
	else if (trigger.match(/^淦話$/) != null) return exports.Testing.SecretTalk(UserN,mainMsg[1]);//測試reply功能用
	else return ['none',''];
