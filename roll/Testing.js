...
function SimBattle(UserID,GroupID,UserN){
	...
	FightInfo[3][2] = new BattleInfo('c','電腦2','測試用電腦2','computer',150,20,1,10,'無','木劍','無','無','無',['火球','簡單廣域治癒術','無'],'無','無','無');
	FightInfo[3][3] = new BattleInfo('c','電腦3','測試用電腦3','computer',150,100,4,20,'無','木劍','無','無','無',['火球','水平四方切','魔力暴風'],'無','未來之力-嵐刃');
