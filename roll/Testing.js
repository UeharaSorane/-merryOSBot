...
function SimBattle(UserID,GroupID,UserN){
	...
	FightInfo[3] = [];//戰鬥員情報
	FightInfo[3][0] = new BattleInfo(UserID,UserN,'測試用玩家','player',50,100,4,10,'無','木劍','無','無','無',['斬擊','水平四方切','無'],'無','無');
	FightInfo[3][1] = new BattleInfo('c','電腦','測試用電腦','player',50,200,1,20,'無','木劍','無','無','無',['簡單治癒術','無','無'],'無','無','無');
