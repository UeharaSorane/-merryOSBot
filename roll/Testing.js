...
function SimBattle(UserID,GroupID,UserN){
	...
	FightInfo[3][1] = new BattleInfo('c','電腦','測試用電腦','computer',10,10,1,20,'無','無','無','無',['無','無','無'],'無','無','無');
	FightInfo[3][2] = new BattleInfo('c','電腦2','測試用電腦2','computer',10,10,1,10,'無','無','無','無',['無','無','無'],'無','無','無');
